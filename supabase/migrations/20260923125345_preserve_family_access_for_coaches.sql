-- A volunteer coach can also be a parent. Promotion must retain their child links.
  ...
  if p_action='enable' then
    ...
    if p_action='transfer_org' then
      ...
      if p_action='remove_member' then
        ...
        -- Keep child links when a parent also becomes a coach. Membership removal still cascades them.
