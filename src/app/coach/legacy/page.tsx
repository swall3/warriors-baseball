        ...
        <section className="w-full rounded-2xl border border-d-sel/40 bg-d-surface p-4 shadow-2xl lg:w-2/3">
          <header className="mb-3 flex items-center justify-between gap-2">
            ...
            <div className="flex shrink-0 gap-2">
              ...
              <Link href="/coach/legacy/lineup" className="rounded-lg border border-d-pos/40 bg-d-pos/10 px-3 py-2.5 text-xs font-semibold uppercase tracking-wide text-d-pos min-h-[44px] flex items-center touch-manipulation">
                Lineup
              </Link>
