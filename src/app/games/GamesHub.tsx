...
// import of BACKUP_SCENARIOS here — the hub is a client component, and
// importing the full scenario pool just to read its .length would still
// bundle every answer into the page anonymous visitors load.
function activitiesFor(backupCount: number) {
  return [
    {
      href: "rules",
      number: "01",
          ...
          {activities.map((a) => (
            ...
            >
              <div className="training-card-top">
                <span>
                  {a.number} / TRAINING
                  {locked && <span className="training-card-lock"> · Members</span>}
                </span>
