...
import { getDailyState, recordDailyPlay, recordAttempt, hasPlayedToday } from "@/lib/gameStorage";

// This is the free public sample (SEATS-AND-GAME-ACCESS.md Decision 2): the
// server resolves and passes only today's single scenario (see
// games/daily/page.tsx) — never the full BACKUP_SCENARIOS pool — so an
// anonymous visitor's client bundle and network response never carry the
// other ~200 scenarios' answers.
export default function DailyGame({ scenario: s }: { scenario: BackupScenario }) {
